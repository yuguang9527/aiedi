  ...
  return (
    ...
    >
      <div>
        <button
          type="button"
          className="bg-white text-black px-4 py-2 rounded-md shadow-lg border inline-flex justify-center w-full text-sm font-medium items-center"
        >
          AI Actions
      ...
      {isDropdownOpen && (
        <div
          className="origin-top-left absolute left-0 mt-1 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none"
        >
          <div className="py-1">
